      ...
      if (e.present === false) {
        await axios.get(process.env.GUPSHUP_URL, {
          params: {
            method: "SendMessage",
            send_to: mobile,
            msg: `Dear Parents, Your child, ${studentName} remained absent in school today.,Vidyakunj School Navsari`,  
            //msg: `Dear Parents,Your child, ${studentName} remained absent in school today.,Vidyakunj School`,  //ORIGNAL MASSAGE//
            msg_type: "TEXT",
      ...
      if (e.present === true && e.late === true) {
        await axios.get(process.env.GUPSHUP_URL, {
          params: {
            method: "SendMessage",
            send_to: mobile,
            msg: `Dear Parents, Today your child ${studentName} remained late in school. Vidyakunj School Navsari`,
            msg_type: "TEXT",
            userid: process.env.GUPSHUP_USER,
            password: process.env.GUPSHUP_PASSWORD,
            auth_scheme: "PLAIN",
